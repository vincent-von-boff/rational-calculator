...
int main(int argc, char** argv){
    ...
    if (argc > 2){
        ...
        Dec_int test_dec_input_1;
        create_dec_int(&test_dec_input_1, argv[1]);
        Dec_int test_dec_input_2;
        create_dec_int(&test_dec_input_2, argv[2]);
        printf("Arg 1: ");
    ...
    Dec_int fib1;
    int stat_1 = create_dec_int(&fib1, "1");
    Dec_int fib2;
    int stat_2 = create_dec_int(&fib2, "1");
    char* str_fib_1 = dec_to_str(&fib1);
    char* str_fib_2 = dec_to_str(&fib2);
    /* printf("Status creation: %d %d\n", stat_1, stat_2); */
    /* printf("Digits of creation: %s %s\n", str_fib_1, str_fib_2); */
    /* printf("Signs of creation: %d %d\n", fib1.sign, fib2.sign); */
    Dec_int temp_fib;
